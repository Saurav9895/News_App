...
const capitalizeFirstLetter = (string)=>{
  ...
  const updateNews = async ()=>{
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=191305c6e29446059e572f4dee64c57d&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true)
